| Data Set | Exp. |                      DV                       |                  IV                   |   Context   | n pots | n faces | n trials: total (train, analyzed) | n subjects collected | n subjects analyzed |
| :------: | :--: | :-------------------------------------------: | :-----------------------------------: | :---------: | :----: | :-----: | :-------------------------------: | :------------------: | :-----------------: |
...
**These comprehension questions were collected but were not used as inclusion criteria and participants' responses were not analyzed.**
